...
function Sports() {
  return (
    <div>
        <Navbar sportsactive=" bg-warning rounded-3"/>
        <div className="sports-heading">
            <div class="bg-dark text-secondary px-4 py-5 text-center">
              <div class="py-5">
                <h1 class="display-5 fw-bold text-white">Sports Inventory Booking</h1>
        ...
        <div className="container">
          <h2 className="heading text-center text-danger py-3 mb-3">Available Sports Inventories</h2>
          <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-2">
            { Inventory.sportItems.map(item => (
              <div class="col">
                 <InventoryItem {...item}/>
              </div>
             ))
